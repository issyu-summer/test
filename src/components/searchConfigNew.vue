      ...
      <div class="in">
        ...
        <div v-if="item.resourceId">
          <el-table :data="item.fields" style="width: 100%" max-height="250">
            ...
            <el-table-column prop="name" label="label" width="160">
              <template slot-scope="scope">
                <el-input
            ...
            <el-table-column label="顺序号" width="80">
              <template slot-scope="scope"> 
                  <el-input v-if="scope.row.selected_field"></el-input>
              </template>
            </el-table-column>
            ...
            <el-table-column label="title" width="120">
              <template slot-scope="scope"> 
                  <el-input v-if="scope.row.selected_result"></el-input>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    commit() {
      ...
      searchConfig(111, this.data).then((response) => {
